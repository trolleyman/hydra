...
// Theme). On (the default): multi-line code blocks get a 1..N gutter - in the
// chat transcript (a Bash command, a tool's JSON input) and on the security
// approval card - so a long line that wraps is not mistaken for a second
// command. Off: plain code, no gutter.
export function CodeLineNumbersSection() {
  ...
  return (
    <SettingSection
      ...
      description="Number the lines of multi-line code blocks - in the chat transcript and on approval cards - so a wrapped long line reads as one line rather than two."
    >
