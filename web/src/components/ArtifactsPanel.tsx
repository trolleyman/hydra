    ...
    <div className="mb-4">
      ...
      <div className="flex flex-wrap items-center gap-2 mb-2 min-h-[1.625rem]">
        ...
        <InfoTooltip title="Artifacts" width={440}>
          ...
          <p><strong>Images &amp; video.</strong> <code className="text-blue-300">.png .jpg .gif</code> are diffed pixel-by-pixel (so cosmetic re-encodes are ignored); other supported types — <code className="text-blue-300">.webp .avif .svg .bmp .pdf</code> and <code className="text-blue-300">.webm</code> video — are compared by byte hash. Video is supported via <code className="text-blue-300">.webm</code> only, and it must be <strong>lossless</strong> (e.g. <code className="text-blue-300">ffmpeg … -c:v libvpx-vp9 -lossless 1</code>): a lossy or non-deterministic encode always reads as changed and produces spurious diffs.</p>
