    ...
    <div className="mb-4">
      ...
      <div className="flex flex-wrap items-center gap-2 mb-2 min-h-[1.625rem]">
        ...
        <InfoTooltip title="Artifacts" width={440}>
          ...
          <p><strong>Images &amp; video.</strong> Still images (<code className="text-blue-300">.png .jpg .gif .webp .avif .svg .bmp</code>) and <code className="text-blue-300">.pdf</code> are diffed pixel-by-pixel. Video is supported via <code className="text-blue-300">.webm</code> only, and it must be <strong>lossless</strong> (e.g. <code className="text-blue-300">ffmpeg … -c:v libvpx-vp9 -lossless 1</code>): video is compared by byte hash rather than pixels, so a lossy or non-deterministic encode always reads as changed and produces spurious diffs.</p>
