...
describe('pictureKind', () => {
  ...
  it('is not fooled by a route name inside a filename', () => {
    expect(pictureKind('/api/projects/p/uploads/blob?name=%2Fartifacts%2Fprojects%2Fx.png')).toBe('upload')
  })
...
describe('agentFilePath / uploadName', () => {
  ...
  it('recovers the stored name of an upload', () => {
    expect(uploadName('/api/projects/p/uploads/blob?name=1699-shot.png')).toBe('1699-shot.png')
  })
