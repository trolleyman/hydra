...
function SpawnForm({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setError(null)
    try {
      const req: SpawnAgentRequest = { prompt: prompt.trim(), agent_type: agentType }
          ...
          <div className="rounded-[10px] bg-white overflow-hidden">
            ...
            <div className="flex items-center justify-between px-2 pb-2 gap-2">
              ...
              <button
                ...
                className="relative overflow-hidden text-[10px] font-semibold px-2.5 py-1 rounded-lg text-white bg-gradient-to-r from-blue-600 to-purple-600 animate-gradient shadow-sm disabled:opacity-40 disabled:cursor-not-allowed transition-opacity hover:opacity-90"
              >
                {loading ? '…' : 'Spawn'}
              </button>
            </div>
          ...
          <div className="relative rounded-2xl p-[1.5px] bg-gradient-to-br from-blue-500 via-indigo-500 to-purple-600 animate-gradient shadow-2xl shadow-blue-500/20">
            <div className="rounded-[14px] bg-white">
              ...
              <textarea
                ...
                rows={5}
                disabled={loading}
                className="w-full px-4 py-2 text-sm text-gray-800 placeholder-gray-400 bg-transparent resize-none focus:outline-none leading-relaxed disabled:opacity-50"
              />
